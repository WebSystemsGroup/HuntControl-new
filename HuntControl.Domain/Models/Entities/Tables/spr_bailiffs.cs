...
namespace HuntControl.Domain.Concrete
{
    ...
    [Table("public.spr_bailiffs")]
    public partial class spr_bailiffs
    {
        ...
        public string name_bailiffs { get; set; }

        [Required]
        [Display(Name = "Адрес")]
        public string address_bailiffs { get; set; }
        ...
        public string head_bailiffs { get; set; }
