...
l.ext.buttons.csvHtml5 = {
    ...
    l.ext.buttons.excelHtml5 = {
        className: "buttons-excel buttons-html5", available: function () { return g.FileReader !== p && (q || g.JSZip) !== p && !G() && v }, text: function (a) {
            ...
            }; i("sheets sheet", a.xl["workbook.xml"]).attr("name", M(b)); b.customizeData && b.customizeData(c); b.header && (d(c.header, e), i("row c", f).attr("s", "2"));
...
l.ext.buttons.pdfHtml5 = {
    ...
    available: function () { return g.FileReader !== p && (r || g.pdfMake) }, text: function (a) { return a.i18n("buttons.pdf", "PDF") }, action: function (a, c, d, b) {
        E(b);
        var a = c.buttons.exportData(b.exportOptions), e = []; b.header && e.push(i.map(a.header, function (a) { return { text: "string" === typeof a ? a : a + "", style: "tableHeader" } }));
        for (var f = 0, h = a.body.length; f < h; f++)
            e.push(i.map(a.body[f], function (a, index) {
                return {
                    text: "string" === typeof a ? a : a + "",// старый вариант text
                    style: f % 2 ? 'tableBodyEven' : 'tableBodyOdd', // стили чередования строк
                    text: $.isNumeric(a) ? a.replace('.', ',') : a, // если а числовое, то заменить . на ,
                    alignment: $.isNumeric(a.replace(',00', "")) ? 'right' : 'left'//если числовое то применить выравнивание right
                };
            }));
    ...
    typeof a ? a : a + "", style: "tableFooter"
        ...
        })); a = { pageSize: b.pageSize, pageOrientation: b.orientation, content: [{ table: { headerRows: 1, body: e }, layout: "1px solid grey" }], styles: { tableHeader: { fontSize: 10, color: "black", fillColor: "#ffffff", alignment: "center"}, tableBodyEven: { }, tableBodyOdd: { fillColor: "#ffffff" }, tableFooter: { bold: !0, fontSize: 11, color: "white", fillColor:"#927972"},title:{alignment:"center",fontSize:15},message:{}},defaultStyle:{fontSize:10}};b.message&&a.content.unshift({text:"function"==typeof b.message?
